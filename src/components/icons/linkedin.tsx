...
export default function LinkedinIcon({className,...rest}: LinkedinIconProps) {
    return (
        <svg className={cn("fill-current",className)} {...rest} width='15' height='15' viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
